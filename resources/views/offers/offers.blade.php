                        ...
                        <div class="col-sm-6 col-md-2">
                            <form action="add_offer">
                                <button class="btn btn-info btn-block">
                                    ...
                                    <i
                                        class="fas fa-plus"></i>&nbsp;  اضافة عروض  التشغيل
                            ...
                            <div class="col-md-8">
                                <a href="/osama">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <p style="font-size:12px;">مدد التشغيل </p>
                                                <h2 class="m-t-0 m-b-0" style="font-size:22px;">
                                                    {{$x->Duration}}                                        </h2>
                                            </div>
                                            <div class="col-md-2">
                                                <p style="font-size:12px;">الجنسية </p>
                                                <h2 class="m-t-0 m-b-0" style="font-size:22px;"> {{$x->nash}}  </h2>
                                            </div>
                                            <div class="col-md-3">
                                                <p style="font-size:12px;">الوظيفة </p>
                                                <h2 class="m-t-0 m-b-0" style="font-size:22px;"> {{$x->work}}   </h2>
                                            </div>

                                            <div class="col-md-2">
                                                <p style="font-size:12px;">سبق لة العمل </p>
                                                <h2 class="m-t-0 m-b-0" style="font-size:22px;"> {{$x->is_work}}   </h2>
                                            </div>

                                            <div class="col-md-2">
                                                <p style="font-size:12px;">الحالة </p>
                                                <h2 class="text-success" style="font-size:22px;"> {{$x->active}}   </h2>
                                            </div>
                                        </div>
