                            ...
                            <form action="{{ route('offers.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <select name="nash" class="form-control SlectBox" onclick="console.log($(this).val())" required
                                    ...
                                    <div class="col">
                                        <label> التأمين</label>
                                        <input type="text" class="form-control" id="tamin" name="tamin2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="work" class="form-control SlectBox" onclick="console.log($(this).val())" required
                                                onchange="console.log('change is firing')">
                                            <!--placeholder-->
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="cost" name="cost2" onkeyup="myFunction()" value="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="Duration" id="Duration" class="form-control SlectBox" onclick="console.log($(this).val())"  required
                                                onchange="console.log('change is firing')">
                                            <!--placeholder-->
                                            <option value="" selected disabled>حدد المدة</option>

                                            @foreach ($Durations as $x)
                                                <option value="{{ $x->Duration_name }}"> {{ $x->Duration_name }}</option>
                                            @endforeach


                                        </select>
                                        <select id="countss" name="countss" class="form-control" onkeydown="myFunction22()" hidden  >
                                        </select>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="is_work" class="form-control SlectBox" onclick="console.log($(this).val())" required
                                                onchange="console.log('change is firing')">
                                            <!--placeholder-->
                                            <option value="غير محدد" selected > الكل</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="main-toggle main-toggle-success">
                                            ...
                                            <label class="rdiobox"><input name="active" value="1"  type="radio" Checked > <span>مفعل </span></label>
                                        <label class="rdiobox"><input name="active" value="0"  type="radio"  > <span>غير مفعل </span></label>
                                    </div>
                                    <div class="col">
                                        <label for="inputName" class="control-label">رواتب العاملة</label>
                                        <input type="text" class="form-control" id="salary" name="salary2" value="0" onkeyup="myFunction()">
                                    </div>
                                </div><br>
                                <div class="row">
                                        ...
                                        <div class=" text-center ">
                                            <table class="table table-striped m-0 pull-left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control justify-content-center" id="cost2" name="cost" value="0.00" style="text-align:center;" readonly >
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" id="Value_VAT" name="vat_cost" style="text-align:center;"  value="0.00" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control justify-content-center" id="tamin2" name="tamin" value="0.00" style="text-align:center;" readonly >
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control justify-content-center" id="salary_2" name="emp_salary" value="0.00" style="text-align:center;" readonly>
                                                    </td>
                                                </tr>
                ...
                <div class="modal-body">
                    <form action="{{ route('sections.store') }}" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" onclick="get_offer()" data-dismiss="modal">تاكيد</button>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            $('#Duration2').change(function() {

                var salary_offer = document.getElementById("salary_offer").value='';
                var cout_total = document.getElementById("cout_total").value='';


                if (typeof salary_offer === 'undefined' || !salary_offer) {

                    alert('يرجي تحديد اجمالي العرض   ');
    ...
    <script>
        function get_offer() {
            ...
            var get_cost = parseFloat(document.getElementById("final_Total").value);//اجمالي العرض

            document.getElementById("cost").value = get_cost;
