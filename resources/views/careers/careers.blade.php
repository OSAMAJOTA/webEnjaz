                ...
                <div class="modal-body">
                    <form action="{{ route('careers.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <label class="rdiobox"><input name="show" value="0"  type="radio" Checked > <span>لا يظهر في العقود  </span></label>
                            <label class="rdiobox"><input name="show" value="1"  type="radio"  > <span>يظهر في العقود </span></label>
