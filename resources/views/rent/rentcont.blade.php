                    ...
                    <div class="card-body text-primary">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                ...
                                <input type="date" class="form-control" id="end_date" name="end_date" value="{{$agents->id}}" readonly  required>
                            ...
                            <div class="col-md-4 price-info">
                                ...
                                <table class="table  m-b-0 p-b-0 VisaCost">
                                    ...
                                    <tr>
                                        <th></th>
                                        <th class="text-danger ApplicantSalary"><input type="text" name="emp_salary" id="emp_salary"  style="text-align:right;font-weight: bold;border: none;" readonly></th>
                                        <th class="text-danger insurance" ><input type="text" name="tamin" id="tamin" style="text-align:right;font-weight: bold;border: none;" readonly> </th>
                                        <th class="text-danger TaxValue"><input type="text" name="vat_cost" id="vat_cost" style="text-align:right;font-weight: bold;border: none;" readonly></th>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr class="period-ddl">
                                        <td>التكلفة</td>
                                        <th  class="text-danger costValueAmount" ><input type="text" name="cost" id="cost" style="text-align:right;font-weight: bold;border: none;" readonly></th>
                                        <th class="text-danger costValuePeriod"><input type="text" name="countss" id="countss" style="text-align:right;font-weight: bold;border: none;"  readonly></th>
                                        <th class="text-danger costValueAmount"><input type="text" name="Total" id="Total" style="text-align:right;font-weight: bold;border: none;" readonly></th>
                                    </tr>
                                    </tbody></table>
                            </div>
                    ...
                    <div class="card-body text-primary">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="emp_num" name="emp_num" value=""  onkeyup="emp_numm()" required >
                                <br>
                                <input type="button" class="btn btn-primary" id="btn_select_emp" name="btn_select_emp"  onclick="no_emp()" title="اذا لم تتوفر عاملة حاليآ يمكن اضافة العاملة لاحقآ" value="لا يوجد عامل في العقد">

                            </div>
                            <div class="col-md-3">

                                <label for="inputName" class="control-label"> <span class="text-danger font-bold"></span>  العاملة</label>
                                <input type="text" class="form-control" id="emp_name" name="emp_name" value="" readonly >
                                <input type="text" class="form-control" id="emp_id" name="emp_id" value="" required hidden>
                                <input type="text" class="form-control" id="connected" name="connected" value="" hidden >
                                <input type="text" class="form-control" id="alert" name="alert" value="0" style="text-align:center;color:#2c7ecd; font-size: 30px; height: 100px; background-color: white; font-weight: bold;border: none; " >
                            <input type="text" class="form-control" id="alert2" name="alert2" value="" style="text-align:center;color: #ee335e; font-size: 30px; height: 100px; background-color: white; font-weight: bold;border: none; " readonly>

                            </div>
                            <div class="col-md-3">
                                <img id="maid_img" width="200px" height="200px" >
<br>

                                <input  class="btn-success " style="font-weight: bold" id="connected_con_id" name="connected_con_id" type="button" value="" onclick="location.href='/ser_cont/1'">
                    ...
                    <div class="card-body text-primary">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="cost3" name="cost3" value="0" readonly>
                                <label for="inputName" class="control-label"> <span class="text-danger font-bold"></span>التامين</label>
                                <input type="text" class="form-control" id="tamin3" name="tamin3" value="0" readonly>
                                <label for="inputName" class="control-label"> <span class="text-danger font-bold"></span> خصم المدير</label>
                                <input type="number" class="form-control" id="man_discount" name="man_discount" value="0" onkeyup="mydiscount()" >
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <input style="text-align:center;color: #2c7ecd; font-size: 88px; height: 100px; background-color: white; font-weight: bold;border: none; " type="text" name="tot" id="tot" value="0.00" readonly >
